...
Route::get('/plans', 'Themsaid\CashierTool\CashierToolController@plans');

Route::get('/user/{user_id}/subscriptions/{subscription_id?}', 'Themsaid\CashierTool\CashierToolController@user');
Route::post('/user/{user_id}/subscriptions/create', 'Themsaid\CashierTool\CashierToolController@createSubscription');
